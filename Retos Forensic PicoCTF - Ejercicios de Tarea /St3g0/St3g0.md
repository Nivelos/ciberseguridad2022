...
Utilizamos el comando zsteg (por el nombre del reto se nos da una idea) y nos da la bandera

┌──(kali㉿kali)-[~/picoCTF/Retos Forensic PicoCTF - Ejercicios de Tarea /St3g0]
└─$ zsteg pico.flag.png 
